...
class OutputCapturer:
    ...
    This class is useful for testing and debugging, where capturing output is necessary.
    It ensures that logged messages are both captured and printed normally.
    """
    ...
    class _TeeStream:
        ...
        def flush(self):
            """
            Flush both the original stream and the buffer to ensure all data is written.
            """
            self.original.flush()
            self.buffer.flush()
    ...
    def __enter__(self):
        """
        Enter the runtime context. Redirects stdout, stderr, and logging output to the capturer.
        """
