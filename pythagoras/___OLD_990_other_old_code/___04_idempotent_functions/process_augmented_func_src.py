...
from pythagoras._010_basic_portals.foundation import get_portal
from pythagoras._030_data_portals.data_portals import DataPortal
from pythagoras.___04_idempotent_functions.astkeywords_dict_convertors import (
...
def process_augmented_func_src(
        input_src: str
        , portal: DataPortal|str|None = NO_PORTAL
        ) -> None:
