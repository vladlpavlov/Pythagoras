...
from pythagoras.___03_OLD_autonomous_functions.autonomous_funcs import (
    AutonomousFn,CodePortal)

from pythagoras.___03_OLD_autonomous_functions.autonomicity_checks import (
    is_autonomous, is_loosely_autonomous)

from pythagoras.___03_OLD_autonomous_functions.autonomous_decorators import (
